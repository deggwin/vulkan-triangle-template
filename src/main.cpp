...
private:
  ...
  void initWindow() {
    ...
    window =
        glfwCreateWindow(WIDTH, HEIGHT, "---- window ----", nullptr, nullptr);
    glfwSetWindowUserPointer(window, this);
    glfwSetFramebufferSizeCallback(window, frameBufferResizeCallback);
  }

  //                                        ### vulkan initialization class
  //                                        function ###
  void initVulkan() {
    createInstance();
    setupDebugMessenger();
  ...
  void createBuffer(VkDeviceSize size, VkBufferUsageFlags usage,
    ...
    allocInfo.memoryTypeIndex =
        findMemType(memRequirements.memoryTypeBits, properties);
  ...
  void createInstance() {
    if (enableValidationLayers && !checkValidationLayersSupport())
      throw std::runtime_error(
          "validation layers requested, but not all available\n");

    VkApplicationInfo appInfo;
    appInfo.sType = VK_STRUCTURE_TYPE_APPLICATION_INFO;
    appInfo.pApplicationName = "---vulkan-win---";
  ...
  void createGraphicsPipeline() {
    ...
    // similar pipeline creation (ctrl + c , ctrl + v)
  ...
  //                                        ### creates the debug messenger used
  //                                        via the blueprint ###
